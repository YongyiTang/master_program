...
feature = load(['max_ac_feature_test_set',num2str(set)]);
label = load(['max_ac_label_test_set',num2str(set)]);
test_label = label.label;
test_data = feature.feature;
feature = load(['max_ac_feature_train_set',num2str(set)]);
label =load(['max_ac_label_train_set',num2str(set)]);
...
%set1 bestc = 2 bestacc= 0.8675
%set2 bestc = 1 bestacc = 0.8953
