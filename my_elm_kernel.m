function [TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy,TY] = my_elm_kernel(train_data,train_label,test_data,test_label, Elm_Type, Regularization_coefficient, Kernel_type, Kernel_para)
