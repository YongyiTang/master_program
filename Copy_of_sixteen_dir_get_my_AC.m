...
for k = 1:33
    ...
    for t = 1: min(frames,size(hog_anno_action,2))
        for i = 1:length(anno.people)
            ...
            ac_feature = zeros((center_time_length+region_num)*total_num,1);%center + 16 region
...
%             k
            ...
            if(region_num == 16 )
                if (int_ac_feature((center_time_length-1)*int_total_num+1) == 4)
                ...
                elseif (int_ac_feature((center_time_length-1)*int_total_num+1) == 5)
                ...
                elseif (int_ac_feature((center_time_length-1)*int_total_num+1) == 6)
                ...
                elseif (int_ac_feature((center_time_length-1)*int_total_num+1) == 7)
                ...
                elseif (int_ac_feature((center_time_length-1)*int_total_num+1) == 8)
                ...
                elseif (int_ac_feature((center_time_length-1)*int_total_num+1) == 1)
                ...
                elseif (int_ac_feature((center_time_length-1)*int_total_num+1) == 2)
...
%             if( t-10 <=0 )
%                 pre_ac = ac_feature;
%             elseif (isempty(ac_feature_cell_temp{i,t-10}))
%                 pre_ac = ac_feature;
%             else
%                 pre_ac = ac_feature_cell_temp{i,t-10};
%             end
%             
%             ac_feature_cell_temp{i,t} = [ac_feature];
