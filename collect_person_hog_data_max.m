        ...
        for j = 1:f_m
            for k = 1:9:f_n-9
                ...
                if (isempty(feature_cell{j,k+9}) == 0)
                    temp_feature = [feature_cell{j,k},feature_cell{j,k+1},feature_cell{j,k+2},feature_cell{j,k+3}, ...
                        feature_cell{j,k+4},feature_cell{j,k+5},feature_cell{j,k+6},feature_cell{j,k+7}, ...
                        feature_cell{j,k+8},feature_cell{j,k+9}];
                    temp_feature = max(temp_feature,[],2);
